...
class ManageRecentAppsProtectionActivity :
    ...
    private fun renderRecommendedSettings(state: RecommendedSettings) {
        val batteryTextTitle = if (state.isIgnoringBatteryOptimizations) R.string.atp_ManageRecentAppsProtectionUnrestrictedBattTitle else R.string.atp_ManageRecentAppsProtectionAllowUnrestrictedBattTitle
        val batteryTextByline = if (state.isIgnoringBatteryOptimizations) R.string.atp_ManageRecentAppsProtectionUnrestrictedBattByline else R.string.atp_ManageRecentAppsProtectionAllowUnrestrictedBattByline
